...
这些数据因采集异常，无分析价值，或会对分析产生重大不利影响而被忽略。
...
**02：** VCT 2026: China Kickoff（Event ID = 2685），BLG vs XLG Middle Final（Match ID = 598941），Map 02 Bind，Round 5，Biank（BLG，防守方，Fade）在爆能器爆炸后被 Rarga 击杀。由于该击杀发生在回合结束后的转场期间且导播镜头已切走，无法通过画面判定具体的击杀坐标，故在数据集中予以剔除。

> https://www.bilibili.com/video/BV1xxcFzbEA7?t=967.6&p=3
